...
echo .
echo /* Original work: Copyright (c) 2020-2021-2022-2023 Refloow All rights reserved.
echo  Code origin (Free GitHub publish): https://github.com/Refloow/Steam-Chat-Logger */
echo .
echo .
